                        ...
                        <div id="login" class="col res-13 tab-1 wide-1 ph-1 right" >
                        	<div id="login-box-container">
                                ...
                                <?php if (is_user_logged_in()){ ?>
                                    ...
                                    <ul><li><a href="/account-management/update-account/">Update Account</a></li>
                               	    <li><a href="/shop/">Continue Order</a></li>
                                    <!--<li><a href="/account-management/my-orders/">View My Orders</a></li>--></ul>
                                
                                <?php }else{ ?>
                                <p>Continue Saved Order</p>
                                <form name="form" method="post" action="/shop"><fieldset>
                                <div class="col res-1" >
                                ...
                                <div class="col res-12 half" >
                                    <p class="small"><a href="/my-account/lost-password/">forgot password?</a></p>
                                </div>
                                <div class="col res-12 half aright" >    
                                    ...
                                    <input type="submit" name="Submit" class="button green" value="log in" />
                                </div>
                                </fieldset></form>
                                <?php } ?>
                                </div> 
